...
$rs_ObjectList->InitFromArray($arResult['SECTIONS']);

$rs_ObjectList->NavStart($arParams['TOP_DEPTH'], false);

$arResult["NAV_STRING"] = $rs_ObjectList->GetPageNavString("", 'kvv_pagenavigation');
